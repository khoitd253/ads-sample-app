...
class MaxNativeAd extends Equatable {
  ...
  MaxNativeAd.fromJson(Map<String, dynamic> json)
      : title = json['title'],
        ...
        isIconImageAvailable = (json['isIconImageAvailable'].runtimeType == int)
            ? (json['isIconImageAvailable'] == 1)
            : json['isIconImageAvailable'],
        isOptionsViewAvailable =
            (json['isOptionsViewAvailable'].runtimeType == int)
                ? (json['isOptionsViewAvailable'] == 1)
                : json['isOptionsViewAvailable'],
        isMediaViewAvailable = (json['isMediaViewAvailable'].runtimeType == int)
            ? (json['isMediaViewAvailable'] == 1)
            : json['isMediaViewAvailable'];
