...
class _NativeAdViewScope extends InheritedWidget {
  ...
  static _MaxNativeAdViewState of(BuildContext context) {
    return context
        .dependOnInheritedWidgetOfExactType<_NativeAdViewScope>()!
        ._scope;
  }

  @override
  bool updateShouldNotify(_NativeAdViewScope oldWidget) {
    // return _scope._nativeAd != oldWidget._scope._nativeAd;
    return _scope._nativeAd?.title == oldWidget._scope._nativeAd?.title ||
        _scope._nativeAd?.advertiser ==
            oldWidget._scope._nativeAd?.advertiser ||
        _scope._nativeAd?.body == oldWidget._scope._nativeAd?.body ||
        _scope._nativeAd?.callToAction ==
            oldWidget._scope._nativeAd?.callToAction ||
...
class MaxNativeAdView extends StatefulWidget {
  ...
  final Widget
      ...
      //   GlobalKey titleViewKey,
      //   GlobalKey advertiserViewKey,
      //   GlobalKey bodyViewKey,
      //   GlobalKey callToActionViewKey,
      //   GlobalKey iconViewKey,
      //   GlobalKey optionsViewKey,
      //   GlobalKey starRatingViewKey,
      //   GlobalKey mediaViewKey,
      // )
      child;
...
class _MaxNativeAdViewState extends State<MaxNativeAdView> {
  ...
  final GlobalKey _titleViewKey = GlobalKey();
  final GlobalKey _advertiserViewKey = GlobalKey();
  final GlobalKey _bodyViewKey = GlobalKey();
  final GlobalKey _callToActionViewKey = GlobalKey();
  final GlobalKey _iconViewKey = GlobalKey();
  final GlobalKey _optionsViewKey = GlobalKey();
  final GlobalKey _starRatingViewKey = GlobalKey();
  final GlobalKey _mediaViewKey = GlobalKey();
  ...
  Future<dynamic> _handleNativeMethodCall(MethodCall call) async {
    ...
    if ("OnNativeAdLoadedEvent" == method) {
      ...
      widget.listener?.onAdLoadFailedCallback(
          adUnitId, AppLovinMAX.createError(arguments));
    } else if ("OnNativeAdClickedEvent" == method) {
      widget.listener
          ?.onAdClickedCallback(AppLovinMAX.createAd(adUnitId, arguments));
    } else if ("OnNativeAdRevenuePaidEvent" == method) {
      widget.listener?.onAdRevenuePaidCallback
          ?.call(AppLovinMAX.createAd(adUnitId, arguments));
    }
  }
...
class MaxNativeAdTitleView extends StatelessWidget {
  ...
  // final GlobalKey titleViewKey;
  // final Function() onSizeChanged;

  @override
  Widget build(BuildContext context) {
    // _NativeAdViewScope.of(context)._titleViewKey =
    //     _NativeAdViewScope.of(context)._titleViewKey;
    return NotificationListener<SizeChangedLayoutNotification>(
      onNotification: (SizeChangedLayoutNotification notification) {
        WidgetsBinding.instance.addPostFrameCallback((_) {
          _NativeAdViewScope.of(context)._addNativeAdComponent(
              _NativeAdViewScope.of(context)._titleViewKey, "addTitleView");
        });
        return false;
      },
...
class MaxNativeAdAdvertiserView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // _NativeAdViewScope.of(context)._advertiserViewKey =
    //     _NativeAdViewScope.of(context)._advertiserViewKey;
    return NotificationListener<SizeChangedLayoutNotification>(
      onNotification: (SizeChangedLayoutNotification notification) {
        WidgetsBinding.instance.addPostFrameCallback((_) {
...
class MaxNativeAdBodyView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // _NativeAdViewScope.of(context)._bodyViewKey =
    //     _NativeAdViewScope.of(context)._bodyViewKey;
    return NotificationListener<SizeChangedLayoutNotification>(
      onNotification: (SizeChangedLayoutNotification notification) {
        WidgetsBinding.instance.addPostFrameCallback((_) {
          _NativeAdViewScope.of(context)._addNativeAdComponent(
              _NativeAdViewScope.of(context)._bodyViewKey, "addBodyView");
        });
        return false;
      },
      child: SizeChangedLayoutNotifier(
...
class MaxNativeAdIconView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // _NativeAdViewScope.of(context)._iconViewKey =
    //     _NativeAdViewScope.of(context)._iconViewKey;
    return NotificationListener<SizeChangedLayoutNotification>(
      onNotification: (SizeChangedLayoutNotification notification) {
        WidgetsBinding.instance.addPostFrameCallback((_) {
          _NativeAdViewScope.of(context)._addNativeAdComponent(
              _NativeAdViewScope.of(context)._iconViewKey, "addIconView");
        });
        return false;
      },
      child: SizeChangedLayoutNotifier(
...
class MaxNativeAdOptionsView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // _NativeAdViewScope.of(context)._optionsViewKey =
    //     _NativeAdViewScope.of(context)._optionsViewKey;
    return NotificationListener<SizeChangedLayoutNotification>(
      onNotification: (SizeChangedLayoutNotification notification) {
        WidgetsBinding.instance.addPostFrameCallback((_) {
          _NativeAdViewScope.of(context)._addNativeAdComponent(
              _NativeAdViewScope.of(context)._optionsViewKey, "addOptionsView");
        });
        return false;
      },
      child: SizeChangedLayoutNotifier(
...
class MaxNativeAdMediaView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // _NativeAdViewScope.of(context)._mediaViewKey =
    //     _NativeAdViewScope.of(context)._mediaViewKey;
    return NotificationListener<SizeChangedLayoutNotification>(
      onNotification: (SizeChangedLayoutNotification notification) {
        WidgetsBinding.instance.addPostFrameCallback((_) {
          _NativeAdViewScope.of(context)._addNativeAdComponent(
              _NativeAdViewScope.of(context)._mediaViewKey, "addMediaView");
        });
        return false;
      },
      child: SizeChangedLayoutNotifier(
...
class _StarRating extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
        children:
            List.generate(kStarCount, (index) => buildStar(context, index)));
  }
}
...
class MaxNativeAdStarRatingView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // _NativeAdViewScope.of(context)._starRatingViewKey =
    //     _NativeAdViewScope.of(context)._starRatingViewKey;
    return Container(
