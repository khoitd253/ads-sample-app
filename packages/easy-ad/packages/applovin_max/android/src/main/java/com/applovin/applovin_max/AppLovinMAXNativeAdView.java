...
public class AppLovinMAXNativeAdView
    ...
    public AppLovinMAXNativeAdView(final int viewId,
        ...
        Log.d("AppLovinSdk", uniqueChannelName);
    ...
    private void loadAd() {
        if (isLoading.compareAndSet(false, true)) {
            ...
            if (adLoader == null || !adUnitId.equals(adLoader.getAdUnitId())) {
                Log.d("AppLovinSdk", "Set new ad loader");
                ...
                Log.d("AppLovinSdk", "Existed ad loader");
            }
    ...
    private class NativeAdListener
        ...
        public void onNativeAdLoaded(@Nullable final MaxNativeAdView nativeAdView, final MaxAd ad) {
            ...
            if (ad.getNativeAd() == null) {
                handleAdLoadFailed("Native ad is null, failing ad load...", null);
    ...
    private void addTitleView(final MethodCall call) {
        Log.d("AppLovinSdk", "addTitleView: " + nativeAd.getNativeAd().getTitle());
    ...
    private void renderAd() {
        if (adLoader != null) {
            Log.d("AppLovinSdk", "Render native ad" + clickableViews.size());
    ...
    private void handleAdLoadFailed(final String message, @Nullable final MaxError error) {
        ...
        if (error != null) {
            Log.e("AppLovinSdk", "OnNativeAdLoadFailedEvent: " + error.getMessage() + " | " + error.getMediatedNetworkErrorMessage());
        }
