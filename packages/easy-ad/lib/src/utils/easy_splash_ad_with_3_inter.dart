...
class _EasySplashAdWith3InterState extends State<EasySplashAdWith3Inter>
  ...
  late final EasyAdBase? _interstitialMediumAd = EasyAds.instance.createInterstitial(
    adNetwork: widget.adNetwork,
  ...
  late final EasyAdBase? _interstitialHighAd = EasyAds.instance.createInterstitial(
    adNetwork: widget.adNetwork,
    ...
    _timer = Timer.periodic(const Duration(milliseconds: 500), (timer) {
      ...
      if (_interstitialHighAd?.isAdLoaded == true) {
        ...
        _ads = _interstitialHighAd;
          ...
          (_interstitialHighAd?.isAdLoadedFailed == true || !widget.configHigh)) {
        _timer?.cancel();
        _timer = null;
        _ads = _interstitialMediumAd;
      } else if (_interstitialAd?.isAdLoaded == true &&
          (_interstitialHighAd?.isAdLoadedFailed == true || !widget.configHigh) &&
          (_interstitialMediumAd?.isAdLoadedFailed == true || !widget.configMedium)) {
        _timer?.cancel();
        _timer = null;
        _ads = _interstitialAd;
      } else if ((_interstitialHighAd?.isAdLoadedFailed == true || !widget.configHigh) &&
          (_interstitialMediumAd?.isAdLoadedFailed == true || !widget.configMedium) &&
